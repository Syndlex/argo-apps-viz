module github.com/syndlex/argo-apps-viz
...
replace (
	// Replace unknown v0.0.0 versions from kubernetes packages imported via argocd, see https://argo-cd.readthedocs.io/en/stable/user-guide/import.
	// See "replace" section in go.mod of argo-cd repo, but use version of our k8s.io/api dependency and only include replacement line for every module
	// "go list -m all" reports the "unknown revision" error for.
